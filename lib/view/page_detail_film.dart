...
class _PageDetailFilmState extends State<PageDetailFilm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _buildDataDetailFilm(),
    );
  }

  Widget _buildDataDetailFilm() {
    return Container(
        child: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                DataDetailFilm detailFilm = DataDetailFilm.fromJson(snapshot.data);
  ...
  Widget _buildItemUsers(DataDetailFilm detailFilm) {
